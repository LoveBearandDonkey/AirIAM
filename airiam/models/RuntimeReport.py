SORT_KEY_BY_ENTITY_TYPE = {
    ...
    'AccountPolicies': 'Arn'
    'AccountRles 'RoleName',
    'AccountUsers': 'UserName'
}


class RuntimeReport:
    def__init__(self, account_id: str, identity_arn: str, raw_results: dict):
    ...
    def set_unused(self, unused_users, unused_roles, unused_active_access_keys, unused_console_login_profiles, unattached_policies, redundant_groups,
        ...
        self._unused_console_log_profiles = sorted(unused_console_login_profiles, key=lambda access_key: access_key['User'])
    ...
    @staticmethod
    def policy_attachment_sorter(policy_attach
        self._user_group_recommendation = user_group_recommendatio
